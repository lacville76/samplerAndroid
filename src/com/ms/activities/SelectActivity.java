    ...
    implements TextWatcher
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        v.setOnTouchListener(new OnSwipeTouchListener(SelectActivity.this) {

			@Override
			public void onSwipeRight() {
				Intent subActivity = new Intent(SelectActivity.this,
						LibraryActivity.class);

				Bundle translateBundle = ActivityOptions.makeCustomAnimation(
						SelectActivity.this, R.anim.slide_in_right,
    ...
    private void showPrivacyDialog() {
        try {
            ...
            intent.setClassName("com.ms.activities","com.ms.activities.EditActivity");
